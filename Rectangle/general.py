...
manipuler des tas de sable sous forme
de tableau numpy se voulant plus efficace
que la classe SandAutomate en utilisant
notamment la compilation avec numba"""
from numpy import array, full, arange
import numpy as np
from numba import jit  # permet de compiler du python
